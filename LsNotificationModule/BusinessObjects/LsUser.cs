...
{
    [DefaultClassOptions, System.ComponentModel.DisplayName("User"), CreatableItem(false)]
    public class LsUser : SecuritySystemUser
    {
        #region Properties
        string _firstName;
        ...
        #endregion
        public LsUser(DevExpress.Xpo.Session session)
            : base(session)
        {
