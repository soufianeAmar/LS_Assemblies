...
namespace lsactvtn
{
    public partial class TrialExtentionAsLicence : Form
    {
        ...
        public TrialExtentionAsLicence()
        {
            InitializeComponent();
        }
        ...
        private void bOk_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Erreur d'activation de la licence", MessageBoxButtons.OK, MessageBoxIcon.Error);
